import { configBtn, configClose, configList, configOverlay, configSave, configStatus } from '../core/dom.js';
...
const normalizeEnumOptions = (opts: any[]) => {
