...
export const isSupportedType = (t?: string) => SUPPORTED_TYPES.includes(String(t || 'unknown'));
...
export const getBounds = (item: any) =>
  item?.meta?.bounds ??
...
export const normalizeStatus = (job: any, item: any) => {
